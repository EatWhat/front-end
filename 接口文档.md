...
| --------------- | -------- | -------- | ------ | -------------------------- |
| customer_id     | true     | number   | 0      | 顾客ID，用于索引顾客       |
| restaurant_name | true     | string   | ""     | 商家名称，用于获取商家信息 |
...
请求："http://localhost:8888/restaurant_name=test/customer_id=1/table_No=1"
...
请求："http://localhost:8888/restaurant_name=test/customer_id=1"
